...
import ac.za.cput.studentaccomodationapp.StudentAccomodationApp;
 ...
 * @author Precious
 */
public class LandlordRegistration extends JFrame implements ActionListener {
    ...
    public LandlordRegistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("StudentAccommodation Landlord Registration");
        ...
        JLabel lblCompany = new JLabel("Building name");
        ...
        webcamBtn.addActionListener(new ActionListener() 
        {
            ...
            public void actionPerformed(ActionEvent ae)
            {
                LandlordRegistration v = new LandlordRegistration();
    ...
    public void actionPerformed(ActionEvent e) {
                ...
                StudentAccomodationApp rg = new StudentAccomodationApp();
                rg.startProgram();
                dispose();
